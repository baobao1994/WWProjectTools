...
#import "WXSCollectionViewCell.h"
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[WXSCollectionViewCell class] forCellWithReuseIdentifier:identifier];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    WXSCollectionViewCell *cell =[collectionView dequeueReusableCellWithReuseIdentifier:identifier forIndexPath:indexPath];
    return cell;
}
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    __weak WXSCollectionViewCell *cell = (WXSCollectionViewCell *)[collectionView cellForItemAtIndexPath:indexPath];
