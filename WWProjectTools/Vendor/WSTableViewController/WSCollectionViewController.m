...
- (void)viewDidLoad {
    ...
    if (!self.collectionView) {
        _collectionView = [[WSRefreshCollectionView alloc]initWithFrame:CGRectMake(0, 0, UIScreenWidth, UIScreenHeight) collectionViewLayout:[[UICollectionViewFlowLayout alloc]init]];
