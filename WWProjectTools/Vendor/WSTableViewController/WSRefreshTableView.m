...
- (void)showNoDataViewWithImage:(UIImage *)image tips:(NSString *)tips {
    if (_noDataView == nil) {
        _noDataView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, UIScreenWidth, UIScreenHeight)];
...
- (void)showCustomView:(UIView*)view {
    ...
    _customView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, UIScreenWidth, UIScreenHeight)];
