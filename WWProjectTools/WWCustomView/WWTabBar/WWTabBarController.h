...
#define WWTABBARCONTROLLER ((WWTabBarController *)self.tabBarController)
 ...
 *  改变默认的UI配置
 *  ----> 可以通过单例 WWTabBarConfig 来改变默认选择的控制器、背景色、字体色等
 *  ----> 如果中间按钮为控制器那么它的索引为添加的个数的最后
 *  ----> [WWTabBarConfig shared]
...
/** tabBar */
@property (strong , nonatomic) WWTabBar *wwtabbar;
/** 拦截点击手势的层 */
